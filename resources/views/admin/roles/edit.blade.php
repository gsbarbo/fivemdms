    ...
    <div class="p-4 dark:text-off-white">
        ...
        <div class="container w-full mx-auto mt-8 md:w-3/5">
            ...
            <form class="space-y-8 divide-y divide-gray-200"
                action="{{ route('portal.admin.roles.update', $role->id) }}" method="POST">
                @method('PUT')
                @csrf
                    ...
                    <div class="container w-full mx-auto lg:w-3/5">
                        <div
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="title" id="title" required value="{{ $role->title }}"
                                    readonly
                                ...
                                @foreach ($permissions as $permission)
                                    <label class="inline-flex items-center text-sm cursor-pointer">
                                        <input
                                            ...
                                            @if (in_array($permission->id, $role_permissions)) checked="checked" @endif>
                                        {{ $permission->title }}
                                    </label>
                                    <br>
                                @endforeach
